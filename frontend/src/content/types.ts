...
/** Max XP from a lesson's *interactive* blocks only (excludes the completion
 * bonus and checkpoint bonus). 0 for a pure-reading lesson. Used as the
 * denominator for the mastery-evidence signal (how correctly the interactive
 * work was done). */
